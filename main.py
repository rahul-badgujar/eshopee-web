...
app.config['SECRET_KEY'] = os.environ.get(
    "SECRET_KEY", "53t98ty935hg92358929gh")
Bootstrap(app)
...
class Products(FlaskForm):
    type = SelectField('Classify Product', choices=[('space_store', 'Space Store'), ('mobiles', 'Mobiles'), ('Electronics', 'Electronics'), (
        'Beauty_And_Makeup', 'Beauty & Makeup'), ('Home_and_Kitchen', 'Home & Kitchen'), ('Computer_Accessories', 'Computer Accessories ')])
